...
if [ $install_nala -eq 1 ]
	then
	wget https://gitlab.com/volian/volian-archive/uploads/b20bd8237a9b20f5a82f461ed0704ad4/volian-archive-keyring_0.1.0_all.deb --output-document="$dir_setup/volian-archive-keyring_0.1.0_all.deb" > /dev/null
